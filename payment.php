...
<!-- this is the paypal engine that will receive the values to be processed using POST method-->
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" >

<!-- Identify your business email previously created in the paypal sandbox so that you can collect the payments. -->
